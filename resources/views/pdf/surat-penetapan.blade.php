...
<body>
    <p style="margin-top: 4cm; text-indent: 1cm; text-align: justify; line-height: 16pt;">Berdasarkan laporan pemakaian
        ...
        yang telah disampaikan lewat pesan WhatsApp pada tanggal 07 Maret 2022, maka dengan ini ditetapkan pajak atas
    ...
    <div style="margin: 0 0 20pt 0;">
        <table style="width: 90%; margin-left: 1cm">
            <tr>
                ...
                <td style="width: 3%">:</td>
                <td style="font-weight: bold">PT. WARU KALTIM PLANTATION</td>
            </tr>
            <tr>
                <td>Alamat</td>
                <td>:</td>
            ...
            <tr>
                <td>Pemakaian</td>
                <td>:</td>
                <td>15.011 m<sup>3</sup></td>
            </tr>
            <tr>
                <td>Dasar NPA</td>
                <td>:</td>
                <td>PERGUB KALTIM NO.10 TAHUN 2011</td>
            </tr>
        </table>
    </div>
    ...
    <div style="margin: 20pt 0 40pt 0; font-size: 10pt">
        <table class="tabel-perhitungan" style="width: 100%; border-collapse: collapse; margin-bottom: 5pt; ">
            ...
            <tr>
                ...
                <td rowspan="5" style="text-align: center; border: 0.5pt solid black;">10%</td>
    ...
    <div style="margin-left: 65%; text-align: center;">
        <span>Penajam, 7 Maret 2022</span>

        <h4 style="font-size: 11pt; margin: 10pt 0 60pt;">Kasi Pendataan & Penetapan</h4>

        <h4 style="font-size: 11pt; margin: 0 0 3pt 0;">Donny Marisya, SE</h4>
        <h5 style="font-size: 11pt; font-weight: 10pt; margin: 0;">NIP. 19760201 200212 1 009</h5>
    </div>
</body>